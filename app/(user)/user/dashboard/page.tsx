...
const DashboardPage = () => {
  return (
    /* bg-[#050505] untuk light, bg-slate-900 untuk dark */
    <main className="p-10 bg-[#f8fafc] dark:bg-[#050505] min-h-screen text-slate-900 dark:text-white font-sans transition-colors duration-300">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-10">
        {[
          ...
          <div
            key={idx}
            className="rounded-3xl bg-white dark:bg-[#111] p-8 border border-slate-200 dark:border-white/5 flex flex-col justify-between h-40 transition-all shadow-sm dark:shadow-none"
          >
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-3xl border border-dashed border-slate-300 dark:border-white/10 flex flex-col items-center justify-center p-8 text-center bg-white dark:bg-[#111]">
